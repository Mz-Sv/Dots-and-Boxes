...
int main() {
    ...
    while (true) {
        ...
        while (mode != '1' && mode != '2' && mode != '3') {
            ...
            cout << "#========================================#\n";
            cout << "|                                        |\n";
            cout << "|  select your game mode (1 or 2 or 3):  |\n";
            cout << "|                                        |\n";
            cout << "#========================================#\n";
            cout << "|                                        |\n";
            cout << "|             1 : two players            |\n";
        ...
        if (mode == '1') {
            ...
            static int nobat;
            char nbt = '0';
            while (nbt != 'A' && nbt != 'B' && nbt != 'a' && nbt != 'b') {
                system("cls");
                cout << "#========================================#\n";
                cout << "|                                        |\n";
                cout << "|            Who starts first?           |\n";
                cout << "| \"A\" for player 1  or  \"B\" for player 2 |\n";
                cout << "|                                        |\n";
                cout << "#========================================#\n";
                cin >> nbt;
            }
        ...
        if (mode == '3') {
            ...
            while (true) {
                ...
                static int pointA, pointPC;
                //titre
                titre(PC_player, pc_player, pointA, pointPC, 8, 8);
                // nobat karbar
                int type, satrUSR = 0, stonUSR = 0, x, y, z;
                if (nobat % 2 == 0) {
